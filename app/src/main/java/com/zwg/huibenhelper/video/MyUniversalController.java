...
public class MyUniversalController extends FrameLayout {
...
//    private boolean mFullscreenEnabled = false;
    ...
    public MyUniversalController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public MyUniversalController(Context context) {
        super(context);
        init(context);
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_LOADING: //3
                    show();
                    showCenterView(com.universalvideoview.R.id.loading_layout);
                    break;
