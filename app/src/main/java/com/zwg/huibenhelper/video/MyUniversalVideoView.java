...
package com.zwg.huibenhelper.video;
...
public class MyUniversalVideoView extends SurfaceView
        implements MyUniversalController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    ...
    private MyUniversalController mMediaController;
    ...
    public MyUniversalVideoView(Context context) {
        this(context,null);
    }

    public MyUniversalVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyUniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyUniversalVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(MyUniversalVideoView.class.getName());
        }
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            if(ex.toString().contains("setDataSourceFD failed")){


                //showOtherDia.setOnDismissListener(new On);
    ...
    public void setMediaController(MyUniversalController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(MyUniversalVideoView.this);
